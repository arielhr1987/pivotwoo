...
//		$db = new \mysqli('127.0.0.1:3306', 'root', 'password', 'testdata');//54745
		$db = new \mysqli('tests-mysql', 'root', 'password', 'testdata');//54745

		//$db = new \wpdb( 'root', '', 'testdata', 'localhost:53429' );
